...
app = Flask(__name__)
app.secret_key = 'non'
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:@localhost/math'  # Update with your database credentials
...
class Score(db.Model):
    ...
    total_time_spent = db.Column(db.Integer, nullable=False)
    time_per_question = db.Column(db.JSON, nullable=False)
